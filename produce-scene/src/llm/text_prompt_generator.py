...
class TextPromptGenerator():
    def __init__(self, model_id='OpenGVLab/InternVL2-8B', awq=False):
    ...
    def parse_result(self, ori_result):
        ...
        if prompt_match:
            ...
            return 'Place the product in the center, product photography, fashion style, light color, \
                    minimalist background, soft light, focus on the product, large depth of field.'