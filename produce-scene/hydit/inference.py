...
class End2End(object):
    ...
    def load_torch_weights(self):
        ...
        # torch.save(self.model.state_dict(), '/home/work/donnhe2/HunyuanDiT/log_EXP/036-dit_g2_full_1024p/pytorch_model_50pre_768_lcm.bin')
    ...
    def predict(self,
        ...
        # print(infer_steps)
        # print(self.args.use_fp16)
        # print(self.args.learn_sigma)
        # print(freqs_cis_img)
