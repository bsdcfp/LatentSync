...
class End2End(object):
    ...
    def load_torch_weights(self):
        ...
        #     controlnet_path = controlnet_dir / f"pytorch_model_{self.args.control_type}_{load_key}.pt"
        controlnet_path = '/home/work/donnhe2/HunyuanDiT/log_EXP/controlnet_epoch1/checkpoints/latest.pt/mp_rank_00_model_states.pt'
        ...
        controlnet_state_dict = torch.load(controlnet_path, map_location=lambda storage, loc: storage)
        new_controlnet_state_dict = controlnet_state_dict['module']
        # for key, value in controlnet_state_dict.items():
        #     if 'module' in key:
        #         for key1 in value.keys():
        #             new_controlnet_state_dict[key1] = value[key1]
        ...
        self.controlnet.load_state_dict(new_controlnet_state_dict, strict=True)
