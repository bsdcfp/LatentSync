...
ckpt_every=100000                                            # create a ckpt every a few steps.
ckpt_latest_every=100000                                     # create a ckpt named `latest.pt` every a few steps.
ckpt_every_n_epoch=2                                          # create a ckpt every a few epochs.
epochs=8                                                      # total training epochs


sh $(dirname "$0")/run_g_torchrun.sh \
    --task-flag ${task_flag} \
