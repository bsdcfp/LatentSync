...
# 在线模式使用示例脚本
# 设置基本路径
SCRIPT_DIR="/home/work/houyi/mmuplt-latentsync"
# 设置辅助目录，包括权重、模板、输入音频等
AUXILIARY_DIR="/home/work/houyi/latentsync_online_simple_auxilary"
...
# 模型和配置路径
INFERENCE_SCRIPT="$SCRIPT_DIR/scripts/inference_online_0701.py"
...
# TEMPLATE_DIR="/home/work/houyi/templates/0612_online_templete_female_32fps_resize_720_1280"
...
# OUTPUT_DIR="/home/work/houyi/outputs/online_mode_test_0624_20s_final"
# OUTPUT_DIR="$SCRIPT_DIR/outputs/online_mode_test_0624_20s_final"
OUTPUT_DIR="$SCRIPT_DIR/outputs/online_mode_test_0701_20s_final_diycache"
