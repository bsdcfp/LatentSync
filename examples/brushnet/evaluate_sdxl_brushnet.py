...
parser.add_argument('--image_save_path', 
                    type=str, 
                    default="runs/evaluation_result/BrushBench/brushnet_sdxl_segmask/inside")
...
evaluation_df = pd.DataFrame(columns=['Image ID','Image Reward', 'Aesthetic Score', 'PSNR', 'LPIPS', 'MSE', 'CLIP Similarity'])
