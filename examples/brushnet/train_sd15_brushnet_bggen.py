...
class MyWebDataset():
    ...
    def __call__(self,examples):
        ...
        masks=[]
        input_ids=[]
        root_dir = '/home/work/llm/BrushNet/data/trainset_beauty_generation'
        for example in examples:
            ...
            mask = cv2.imdecode(np.asarray(bytearray(example["mask"]), dtype="uint8"), cv2.IMREAD_COLOR) / 255.
            ...
            mask=cv2.resize(mask,(h_new,w_new),interpolation=cv2.INTER_CUBIC)[:,:,0][:,:,np.newaxis]
