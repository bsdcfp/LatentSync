...
from trt_latentsync.src.models.unet import UNet3DConditionModel
from trt_latentsync.src.pipelines.lipsync_pipeline_online_0701 import LipsyncPipeline_online_0701 as LipsyncPipeline
from diffusers.utils.import_utils import is_xformers_available
from accelerate.utils import set_seed
from trt_latentsync.src.whisper.audio2feature import Audio2Feature
import os
...
try:
    ...
    try:
        ...
        from trt_latentsync.src.models.unet import UNet3DConditionOutput
    except ImportError:
...
from trt_latentsync.src.utils.video_sequence_merger import VideoIndexGenerator
...
def main(config, args):
    ...
    pipeline.generate_video_online_0701(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--verbose", action="store_true", default=False, help="启用详细输出")

    # 在线模式必需参数
    parser.add_argument("--video_cache_dir", type=str, 
                       default="/home/work/houyi/templates/0612_online_templete_female_32fps_features",
                       help="视频特征缓存目录")
