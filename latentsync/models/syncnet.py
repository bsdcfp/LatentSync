...
class SyncNet(nn.Module):
    ...
    def forward(self, image_sequences, audio_sequences): # image_sequences: torch.Size([1, 48, 192, 384])
        vision_embeds = self.visual_encoder(image_sequences)  # (b, c, 1, 1) # torch.Size([1, 2048, 1, 1])
...
class DownEncoder2D(nn.Module):
    ...
    def forward(self, hidden_states):
        hidden_states = self.conv_in(hidden_states) # self.conv_in.weight.shape: torch.Size([64, 48, 3, 3]) / # self.conv_in.bias.shape: torch.Size([64])

        # original 384 down # 1. torch.Size([1, 48, 192, 384]) 2. torch.Size([1, 64, 192, 192]) 3. torch.Size([1, 128, 96, 96]) 4. torch.Size([1, 256, 48, 48]) 5. torch.Size([1, 256, 24, 24]) 6. torch.Size([1, 512, 12, 12]) 7.torch.Size([1, 1024, 6, 6]) 8.  torch.Size([1, 2048, 3, 3])  9. torch.Size([1, 2048, 1, 1])
        # new 256 down # 1. torch.Size([1, 64, 128, 256]) 2. torch.Size([1, 64, 128, 128]) 3. torch.Size([1, 128, 64, 64]) 4. torch.Size([1, 256, 32, 32]) 5. torch.Size([1, 256, 16, 16]) 6. torch.Size([1, 512, 8, 8]) 7.torch.Size([1, 1024, 4, 4]) 8.  torch.Size([1, 2048, 2, 2])  9. torch.Size([1, 2048, 1, 1]) 
        for down_block in self.down_blocks:
            hidden_states = down_block(hidden_states) # deepest: torch.Size([1, 2048, 3, 3])
