...
class VideoSelectedInfo:
    def __init__(self, connected_json_path, video_info_json_path, shot_video_json_path, start_video_list_path, debug=False):
        ...
        self.start_videos_list = self.read_json_file(start_video_list_path)
        self.fps = 25
        self.debug = debug
...
class VideoIndexGenerator:
    ...
    def __init__(self, connected_json_path, video_info_json_path, shot_video_json_path, start_video_list_path, video_template_dir, 
        ...
        # 初始化视频选择器
        self.video_selector = VideoSelectedInfo(connected_json_path, video_info_json_path, shot_video_json_path, start_video_list_path, debug)
        
        # 初始化视频合并器
        self.video_merger = VideoSequenceMerger(target_fps, transition_frames, debug)
    
    # @profile
    def get_video_index(self, audio_path=None, audio_duration=None, output_path=None):
        """
        根据音频路径生成视频索引
...
if __name__ == "__main__":
    ...
    video_info_json_path = "/Users/wang.li/Downloads/video_templete_32fps_info.json"
    shot_video_json_path = '/Users/wang.li/Downloads/connected_videos_other_short.json'
    start_video_list_path = '/Users/wang.li/Downloads/start_video_list.json'
